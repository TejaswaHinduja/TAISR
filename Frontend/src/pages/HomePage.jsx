...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex flex-col items-center justify-center p-4 relative">
      ...
      {/* Twitter login button at top-right */}
      ...
      <div className="fixed bottom-10 left-10 md:block hidden bg-gray-800/70 p-4 rounded-lg shadow-lg border border-gray-700 max-w-xs">
